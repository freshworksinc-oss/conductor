...
public interface MetadataDAO {
    ...
    /**
     * Returns version summaries for a specific workflow without loading full definition bodies.
     * Persistence modules should override this with an optimized query.
     *
     * @param name workflow name
     * @return list of version summaries sorted by version number
     */
